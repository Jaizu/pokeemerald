...
const u8 gText_MysteryGiftCantUse[] = _("Mystery Gifts can't be used while\nthe Wireless Adapter is attached.");
...
const u8 gText_DefaultNameGaia[] = _("Gaia");
const u8 gText_DefaultNameCoulter[] = _("Coulter");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pRedwood's Pokédex rating!\pRedwood: Let's see…\p");
...
const u8 gText_DadsAdvice[] = _("Mom's advice…\nThere's a time and place for everything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_LiteBluePokeblock[] = _("Cyan {POKEBLOCK}");
...
const u8 gText_EggWillTakeALongTime[] = _("This Egg will\ntake a long\ntime to hatch.");
...
const u8 gText_EggFromHotSprings[] = _("A Pokémon Egg obtained from Vincent\nat the Aerous Art Club.");
...
const u8 gText_Bicycle_1000000[] = _("Bicycle{CLEAR_TO 0x49}{SIZE 0x00}¥1,000,000");
...
const u8 gText_LanettesPC[] = _("Neta's PC");
