...
static const u8 *const gPlayerPresetNames[] = {
    gText_DefaultNameTerra,
    gText_DefaultNameGaia
};
...
static void Task_NewGameBirchSpeech_WaitToShowBirch(u8 taskId)
{
    ...
    else
    {
        ...
        NewGameBirchSpeech_StartFadePlatformOut(taskId, 5);
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_KABUTO);
...
{
    return CreatePicSprite2(SPECIES_KABUTO, SHINY_ODDS, 0, 1, a, b, 14, -1);
}
...
static void NewGameBirchSpeech_SetDefaultPlayerName(void)
{
    ...
    name = gPlayerPresetNames[gSaveBlock2Ptr->playerGender];
...
static void MainMenu_FormatSavegameTime(void)
{
    ...
    *ptr = 0xF0;
    ...
    AddTextPrinterParameterized3(2, 2, GetStringRightAlignXOffset(1, str, 0xCE), 17, sTextColor_MenuInfo, -1, str);
}
