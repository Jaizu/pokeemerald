...
static const u16 sPoints_MoveEffect[NUM_BATTLE_MOVE_EFFECTS] =
{
    ...
    [EFFECT_HEAT_CRASH] = 1,
    [EFFECT_PUNISHMENT] = 1,
    [EFFECT_STORED_POWER] = 1,
    [EFFECT_ELECTRO_BALL] = 1,
    [EFFECT_GYRO_BALL] = 1,
    [EFFECT_ECHOED_VOICE] = 1,
    [EFFECT_PAYBACK] = 1,
    [EFFECT_ROUND] = 1,
    [EFFECT_BRINE] = 1,
    [EFFECT_VENOSHOCK] = 1,
    ...
    [EFFECT_ROOST] = 1,
    [EFFECT_GRAVITY] = 1,
    [EFFECT_MIRACLE_EYE] = 1,
    [EFFECT_TAILWIND] = 1,
    [EFFECT_EMBARGO] = 1,
    [EFFECT_AQUA_RING] = 1,
    [EFFECT_TRICK_ROOM] = 1,
    [EFFECT_WONDER_ROOM] = 1,
    [EFFECT_MAGIC_ROOM] = 1,
    [EFFECT_MAGNET_RISE] = 1,
    [EFFECT_TOXIC_SPIKES] = 1,
    [EFFECT_GASTRO_ACID] = 1,
    [EFFECT_STEALTH_ROCK] = 1,
    [EFFECT_TELEKINESIS] = 1,
    [EFFECT_POWER_SWAP] = 1,
    [EFFECT_GUARD_SWAP] = 1,
    [EFFECT_HEART_SWAP] = 1,
    [EFFECT_POWER_SPLIT] = 1,
    [EFFECT_GUARD_SPLIT] = 1,
    [EFFECT_STICKY_WEB] = 1,
    [EFFECT_METAL_BURST] = 1,
    [EFFECT_LUCKY_CHANT] = 1,
    [EFFECT_SUCKER_PUNCH] = 1,
    [EFFECT_SPECIAL_DEFENSE_DOWN_HIT_2] = 1,
    [EFFECT_SIMPLE_BEAM] = 1,
    [EFFECT_ENTRAINMENT] = 1,
    [EFFECT_HEAL_PULSE] = 1,
    [EFFECT_QUASH] = 1,
    [EFFECT_ION_DELUGE] = 1,
    [EFFECT_FREEZE_DRY] = 1,
    [EFFECT_TOPSY_TURVY] = 1,
    [EFFECT_MISTY_TERRAIN] = 1,
    [EFFECT_GRASSY_TERRAIN] = 1,
    [EFFECT_ELECTRIC_TERRAIN] = 1,
    [EFFECT_PSYCHIC_TERRAIN] = 1,
    [EFFECT_ATTACK_ACCURACY_UP] = 1,
    [EFFECT_ATTACK_SPATK_UP] = 1,
    [EFFECT_HURRICANE] = 1,
    [EFFECT_TWO_TYPED_MOVE] = 1,
    [EFFECT_ME_FIRST] = 1,
    [EFFECT_SPEED_UP_HIT] = 1,
    [EFFECT_QUIVER_DANCE] = 1,
    [EFFECT_COIL] = 1,
    [EFFECT_ELECTRIFY] = 1,
    [EFFECT_SCALD] = 1,
    [EFFECT_REFLECT_TYPE] = 1,
    [EFFECT_SOAK] = 1,
    [EFFECT_GROWTH] = 1,
    [EFFECT_CLOSE_COMBAT] = 1,
    [EFFECT_LAST_RESORT] = 1,
    [EFFECT_RECOIL_33_STATUS] = 1,
    [EFFECT_FLINCH_STATUS] = 1,
    [EFFECT_RECOIL_50] = 1,
    [EFFECT_SHELL_SMASH] = 1,
    [EFFECT_SHIFT_GEAR] = 1,
    [EFFECT_DEFENSE_UP_3] = 1,
    [EFFECT_NOBLE_ROAR] = 1,
    [EFFECT_VENOM_DRENCH] = 1,
    [EFFECT_TOXIC_THREAD] = 1,
    [EFFECT_CLEAR_SMOG] = 1,
    [EFFECT_HIT_SWITCH_TARGET] = 1,
    [EFFECT_FINAL_GAMBIT] = 1,
    [EFFECT_CHANGE_TYPE_ON_ITEM] = 1,
    [EFFECT_AUTOTOMIZE] = 1,
    [EFFECT_COPYCAT] = 1,
    [EFFECT_DEFOG] = 1,
    [EFFECT_HIT_ENEMY_HEAL_ALLY] = 1,
    [EFFECT_SMACK_DOWN] = 1,
    [EFFECT_SYNCHRONOISE] = 1,
    [EFFECT_PSYCHO_SHIFT] = 1,
    [EFFECT_POWER_TRICK] = 1,
    [EFFECT_FLAME_BURST] = 1,
    [EFFECT_AFTER_YOU] = 1,
    [EFFECT_BESTOW] = 1,
    [EFFECT_ROTOTILLER] = 1,
    [EFFECT_FLOWER_SHIELD] = 1,
    [EFFECT_HIT_PREVENT_ESCAPE] = 1,
    [EFFECT_SPEED_SWAP] = 1,
    [EFFECT_DEFENSE_UP2_HIT] = 1,
    [EFFECT_REVELATION_DANCE] = 1,
    [EFFECT_AURORA_VEIL] = 1,
    [EFFECT_THIRD_TYPE] = 1,
    [EFFECT_FEINT] = 1,
    [EFFECT_SPARKLING_ARIA] = 1,
    [EFFECT_ACUPRESSURE] = 1,
    [EFFECT_AROMATIC_MIST] = 1,
    [EFFECT_POWDER] = 1,
    [EFFECT_SP_ATTACK_UP_HIT] = 1,
    [EFFECT_BELCH] = 1,
    [EFFECT_PARTING_SHOT] = 1,
    [EFFECT_SPECTRAL_THIEF] = 1,
    [EFFECT_V_CREATE] = 1,
    [EFFECT_MAT_BLOCK] = 1,
    [EFFECT_STOMPING_TANTRUM] = 1,
    [EFFECT_CORE_ENFORCER] = 1,
    [EFFECT_INSTRUCT] = 1,
    [EFFECT_THROAT_CHOP] = 1,
    [EFFECT_LASER_FOCUS] = 1,
    [EFFECT_MAGNETIC_FLUX] = 1,
    [EFFECT_GEAR_UP] = 1,
    [EFFECT_INCINERATE] = 1,
    [EFFECT_BUG_BITE] = 1,
    [EFFECT_STRENGTH_SAP] = 1,
    [EFFECT_MIND_BLOWN] = 1,
    [EFFECT_PURIFY] = 1,
    [EFFECT_BURN_UP] = 1,
    [EFFECT_SHORE_UP] = 1,
