static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ARCHAN_TOWN - 1] = {MAP_GROUP(ARCHAN_TOWN), MAP_NUM(ARCHAN_TOWN), 29, 12},
    [HEAL_LOCATION_SEROS_VILLAGE - 1] = {MAP_GROUP(SEROS_VILLAGE), MAP_NUM(SEROS_VILLAGE), 30, 25},
    [HEAL_LOCATION_AEROUS_CITY - 1] = {MAP_GROUP(AEROUS_CITY), MAP_NUM(AEROUS_CITY), 24, 17},
    [HEAL_LOCATION_NESTPINE_TOWN - 1] = {MAP_GROUP(NESTPINE_TOWN), MAP_NUM(NESTPINE_TOWN), 4, 19},
    [HEAL_LOCATION_WINDMIST_CITY - 1] = {MAP_GROUP(WINDMIST_CITY), MAP_NUM(WINDMIST_CITY), 15, 6},
    [HEAL_LOCATION_SABULO_ISLAND - 1] = {MAP_GROUP(SABULO_ISLAND), MAP_NUM(SABULO_ISLAND), 11, 16},
    [HEAL_LOCATION_VALOON_TOWN - 1] = {MAP_GROUP(VALOON_TOWN), MAP_NUM(VALOON_TOWN), 22, 16},
    [HEAL_LOCATION_VALOON_TOWN_RANGERS_HQ - 1] = {MAP_GROUP(VALOON_TOWN_RANGERS_HQ), MAP_NUM(VALOON_TOWN_RANGERS_HQ), 10, 3},
    [HEAL_LOCATION_BATTLE_MARSH - 1] = {MAP_GROUP(BATTLE_MARSH), MAP_NUM(BATTLE_MARSH), 32, 10},
    [HEAL_LOCATION_TELMURK_CITY - 1] = {MAP_GROUP(TELMURK_CITY), MAP_NUM(TELMURK_CITY), 14, 16},
};
