static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CELANTO_TOWN - 1] = {MAP_GROUP(CELANTO_TOWN), MAP_NUM(CELANTO_TOWN), 37, 16},
    [HEAL_LOCATION_RELIQUIA_RUINS - 1] = {MAP_GROUP(RELIQUIA_RUINS), MAP_NUM(RELIQUIA_RUINS), 21, 0},
    [HEAL_LOCATION_ARCHAN_TOWN - 1] = {MAP_GROUP(ARCHAN_TOWN), MAP_NUM(ARCHAN_TOWN), 27, 12},
};
