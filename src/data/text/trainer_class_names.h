const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_EXPLORER] = _("Explorer"),
    ...
    [TRAINER_CLASS_WELDER] = _("Welder"),
    [TRAINER_CLASS_SWIMMER_M] = _("Swimmer ♂"),
    [TRAINER_CLASS_NEW_ELDERS] = _("New Elders"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_ELDER_KNIGHT] = _("Elder Knight"),
    ...
    [TRAINER_CLASS_GUITARIST] = _("Rocker"),
    ...
    [TRAINER_CLASS_PKMN_TRAINER_3] = _("Rival"),
    ...
    [TRAINER_CLASS_SUCCESSOR] = _("Successor"),
