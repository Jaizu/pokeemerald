const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_EXPLORER] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_WELDER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FAIRY_TALE_GIRL] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SWIMMER_M] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_NEW_ELDERS_GRUNT_M] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_EXPERT_M] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_EUNICE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BLACK_BELT] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_NEW_ELDERS_GRUNTS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ENOCH] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_NEW_ELDERS_GRUNT_F] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_ARIA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_NINA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_VERNON] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_WORKER] = {.size = 8, .y_offset = 2},
    [TRAINER_PIC_ARTIST] = {.size = 8, .y_offset = 2},
    ...
    [TRAINER_PIC_FISHERMAN_MAGIKARP] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_GOLDEEN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_RELICANTH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_HORSEA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_CORPHISH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_DRATINI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_TRUBBISH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_TIRE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_SHINY_GOLDEEN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_SHINY_RELICANTH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_FISHERMAN_SHINY_TRUBBISH] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_COULTER] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_BELLE] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(EXPLORER, gTrainerFrontPic_Explorer, 0x800),
    ...
    TRAINER_SPRITE(WELDER, gTrainerFrontPic_Welder, 0x800),
    ...
    TRAINER_SPRITE(NEW_ELDERS_GRUNT_M, gTrainerFrontPic_NewEldersGruntM, 0x800),
    TRAINER_SPRITE(EXPERT_M, gTrainerFrontPic_ExpertM, 0x800),
    TRAINER_SPRITE(EUNICE, gTrainerFrontPic_Eunice, 0x800),
    TRAINER_SPRITE(BLACK_BELT, gTrainerFrontPic_BlackBelt, 0x800),
    TRAINER_SPRITE(NEW_ELDERS_GRUNTS, gTrainerFrontPic_NewEldersGrunts, 0x800),
    TRAINER_SPRITE(ENOCH, gTrainerFrontPic_Enoch, 0x800),
    ...
    TRAINER_SPRITE(NEW_ELDERS_GRUNT_F, gTrainerFrontPic_NewEldersGruntF, 0x800),
    ...
    TRAINER_SPRITE(ARIA, gTrainerFrontPic_Aria, 0x800),
    TRAINER_SPRITE(NINA, gTrainerFrontPic_Nina, 0x800),
    TRAINER_SPRITE(VERNON, gTrainerFrontPic_Vernon, 0x800),
    ...
    TRAINER_SPRITE(WORKER, gTrainerFrontPic_Worker, 0x1000),
    TRAINER_SPRITE(ARTIST, gTrainerFrontPic_Artist, 0x1000),
    ...
    TRAINER_SPRITE(FISHERMAN_MAGIKARP, gTrainerFrontPic_FishermanMagikarp, 0x800),
    TRAINER_SPRITE(FISHERMAN_GOLDEEN, gTrainerFrontPic_FishermanGoldeen, 0x800),
    TRAINER_SPRITE(FISHERMAN_RELICANTH, gTrainerFrontPic_FishermanRelicanth, 0x800),
    TRAINER_SPRITE(FISHERMAN_HORSEA, gTrainerFrontPic_FishermanHorsea, 0x800),
    TRAINER_SPRITE(FISHERMAN_CORPHISH, gTrainerFrontPic_FishermanCorphish, 0x800),
    TRAINER_SPRITE(FISHERMAN_DRATINI, gTrainerFrontPic_FishermanDratini, 0x800),
    TRAINER_SPRITE(FISHERMAN_TRUBBISH, gTrainerFrontPic_FishermanTrubbish, 0x800),
    TRAINER_SPRITE(FISHERMAN_TIRE, gTrainerFrontPic_FishermanTire, 0x800),
    TRAINER_SPRITE(FISHERMAN_SHINY_GOLDEEN, gTrainerFrontPic_FishermanShinyGoldeen, 0x800),
    TRAINER_SPRITE(FISHERMAN_SHINY_RELICANTH, gTrainerFrontPic_FishermanShinyRelicanth, 0x800),
    TRAINER_SPRITE(FISHERMAN_SHINY_TRUBBISH, gTrainerFrontPic_FishermanShinyTrubbish, 0x800),
    ...
    TRAINER_SPRITE(COULTER, gTrainerFrontPic_Coulter, 0x800),
    ...
    TRAINER_SPRITE(BELLE, gTrainerFrontPic_Belle, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(EXPLORER, gTrainerPalette_Explorer),
    ...
    TRAINER_PAL(WELDER, gTrainerPalette_Welder),
    TRAINER_PAL(FAIRY_TALE_GIRL, gTrainerPalette_FairyTaleGirl),
    TRAINER_PAL(SWIMMER_M, gTrainerPalette_SwimmerM),
    TRAINER_PAL(NEW_ELDERS_GRUNT_M, gTrainerPalette_NewEldersGruntM),
    TRAINER_PAL(EXPERT_M, gTrainerPalette_ExpertM),
    TRAINER_PAL(EUNICE, gTrainerPalette_Eunice),
    TRAINER_PAL(BLACK_BELT, gTrainerPalette_BlackBelt),
    TRAINER_PAL(NEW_ELDERS_GRUNTS, gTrainerPalette_NewEldersGrunts),
    TRAINER_PAL(ENOCH, gTrainerPalette_Enoch),
    ...
    TRAINER_PAL(NEW_ELDERS_GRUNT_F, gTrainerPalette_NewEldersGruntF),
    ...
    TRAINER_PAL(ARIA, gTrainerPalette_Aria),
    TRAINER_PAL(NINA, gTrainerPalette_Nina),
    TRAINER_PAL(VERNON, gTrainerPalette_Vernon),
    ...
    TRAINER_PAL(FISHERMAN_MAGIKARP, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_GOLDEEN, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_RELICANTH, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_HORSEA, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_CORPHISH, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_DRATINI, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_TRUBBISH, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_TIRE, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_SHINY_GOLDEEN, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_SHINY_RELICANTH, gTrainerPalette_Fisherman),
    TRAINER_PAL(FISHERMAN_SHINY_TRUBBISH, gTrainerPalette_Fisherman),
    ...
    TRAINER_PAL(COULTER, gTrainerPalette_Coulter),
    ...
    TRAINER_PAL(BELLE, gTrainerPalette_Belle),
