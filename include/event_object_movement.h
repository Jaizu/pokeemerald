...
#define GROUND_EFFECT_FLAG_SNOWY_TALL_GRASS_ON_SPAWN  (1 << 21)
#define GROUND_EFFECT_FLAG_SNOWY_TALL_GRASS_ON_MOVE   (1 << 22)
#define GROUND_EFFECT_FLAG_LAND_IN_SNOWY_TALL_GRASS   (1 << 23)
#define GROUND_EFFECT_FLAG_SWAMPY_TALL_GRASS_ON_SPAWN (1 << 24)
#define GROUND_EFFECT_FLAG_SWAMPY_TALL_GRASS_ON_MOVE  (1 << 25)
#define GROUND_EFFECT_FLAG_LAND_IN_SWAMPY_TALL_GRASS  (1 << 26)
