...
#define FLAG_HIDDEN_ITEM_ROUTE_104_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x58) // TODO: Remove references to this
#define FLAG_HIDDEN_ITEM_CELANTO_PATH_ANTIDOTE               (FLAG_HIDDEN_ITEMS_START + 0x58) // FLAG_HIDDEN_ITEM_ROUTE_104_HEART_SCALE in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_105_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x59) // TODO: Remove references to this
#define FLAG_HIDDEN_ITEM_CELANTO_PATH_BURN_HEAL              (FLAG_HIDDEN_ITEMS_START + 0x59) // FLAG_HIDDEN_ITEM_ROUTE_105_HEART_SCALE in Emerald
