...
#define FLAG_UNLOCK_SABULO_ISLAND_DOORS                     0x81 // FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN in Emerald
#define FLAG_RECEIVED_KANTO_STARTER                         0x82 // FLAG_DEFEATED_RIVAL_ROUTE103 in Emerald
...
#define FLAG_TOLD_ABOUT_VALOON_GYM_OPENING                  0x98 // FLAG_RECEIVED_SUPER_ROD in Emerald
#define FLAG_VALOON_NPC_TRADE_COMPLETED                     0x99 // FLAG_RUSTBORO_NPC_TRADE_COMPLETED in Emerald
#define FLAG_RECEIVED_TM09                                  0x9A // FLAG_PACIFIDLOG_NPC_TRADE_COMPLETED in Emerald
#define FLAG_BATTLE_MARSH_NPC_TRADE_COMPLETED               0x9B // FLAG_FORTREE_NPC_TRADE_COMPLETED in Emerald
#define FLAG_RECEIVED_BATTLE_MARSH_CHOICE_SPECS             0x9C // FLAG_BATTLE_FRONTIER_TRADE_DONE in Emerald
...
#define FLAG_RECEIVED_WINDMIST_CITY_ICY_ROCK                0xA2 // FLAG_CUTE_PAINTING_MADE in Emerald
...
#define FLAG_RECEIVED_TM09_OLD               0x106 // FLAG_RECEIVED_TM09 in Emerald
...
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_POKE_BALL             (FLAG_HIDDEN_ITEMS_START + 0x08) // FLAG_HIDDEN_ITEM_UNDERWATER_124_CARBOS in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_RARE_BONE             (FLAG_HIDDEN_ITEMS_START + 0x09) // FLAG_HIDDEN_ITEM_UNDERWATER_124_GREEN_SHARD in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_NUGGET                (FLAG_HIDDEN_ITEMS_START + 0x0A) // FLAG_HIDDEN_ITEM_UNDERWATER_124_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_BLUE_SHARD            (FLAG_HIDDEN_ITEMS_START + 0x0B) // FLAG_HIDDEN_ITEM_UNDERWATER_124_BIG_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_AWAKENING             (FLAG_HIDDEN_ITEMS_START + 0x0C) // FLAG_HIDDEN_ITEM_UNDERWATER_126_BLUE_SHARD in Emerald
#define FLAG_HIDDEN_ITEM_SEROS_PATH_NEST_BALL                (FLAG_HIDDEN_ITEMS_START + 0x0D) // FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_1 in Emerald
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_POTION                  (FLAG_HIDDEN_ITEMS_START + 0x0E) // FLAG_HIDDEN_ITEM_UNDERWATER_126_HEART_SCALE in Emerald
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_REVIVE                  (FLAG_HIDDEN_ITEMS_START + 0x0F) // FLAG_HIDDEN_ITEM_UNDERWATER_126_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_COULTERS_HOUSE_2F_RARE_CANDY        (FLAG_HIDDEN_ITEMS_START + 0x10) // FLAG_HIDDEN_ITEM_UNDERWATER_126_STARDUST in Emerald
#define FLAG_HIDDEN_ITEM_WISP_FOREST_SUPER_POTION            (FLAG_HIDDEN_ITEMS_START + 0x11) // FLAG_HIDDEN_ITEM_UNDERWATER_126_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_WISP_FOREST_ANTIDOTE                (FLAG_HIDDEN_ITEMS_START + 0x12) // FLAG_HIDDEN_ITEM_UNDERWATER_126_YELLOW_SHARD in Emerald
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_ETHER                   (FLAG_HIDDEN_ITEMS_START + 0x13) // FLAG_HIDDEN_ITEM_UNDERWATER_126_IRON in Emerald
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_X_ATTACK                (FLAG_HIDDEN_ITEMS_START + 0x14) // FLAG_HIDDEN_ITEM_UNDERWATER_126_BIG_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_HILLS_RARE_CANDY             (FLAG_HIDDEN_ITEMS_START + 0x15) // FLAG_HIDDEN_ITEM_UNDERWATER_127_STAR_PIECE in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_HILLS_REVIVE                 (FLAG_HIDDEN_ITEMS_START + 0x16) // FLAG_HIDDEN_ITEM_UNDERWATER_127_HP_UP in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_IRON                  (FLAG_HIDDEN_ITEMS_START + 0x17) // FLAG_HIDDEN_ITEM_UNDERWATER_127_HEART_SCALE in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_STARDUST              (FLAG_HIDDEN_ITEMS_START + 0x18) // FLAG_HIDDEN_ITEM_UNDERWATER_127_RED_SHARD in Emerald
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_HARD_STONE            (FLAG_HIDDEN_ITEMS_START + 0x19) // FLAG_HIDDEN_ITEM_UNDERWATER_128_PROTEIN in Emerald
#define FLAG_HIDDEN_ITEM_NESTPINE_CLIMB_ELIXIR               (FLAG_HIDDEN_ITEMS_START + 0x1A) // FLAG_HIDDEN_ITEM_UNDERWATER_128_PEARL in Emerald
...
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_ICE_HEAL             (FLAG_HIDDEN_ITEMS_START + 0x24) // FLAG_HIDDEN_ITEM_UNDERWATER_124_CALCIUM in Emerald
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_PROTEIN              (FLAG_HIDDEN_ITEMS_START + 0x25) // FLAG_HIDDEN_ITEM_ROUTE_104_POTION in Emerald
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_X_SP_DEF             (FLAG_HIDDEN_ITEMS_START + 0x26) // FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_2 in Emerald
...
#define FLAG_HIDDEN_ITEM_SABULO_ISLAND_STARDUST              (FLAG_HIDDEN_ITEMS_START + 0x30) // FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVERSTONE_1 in Emerald
#define FLAG_HIDDEN_ITEM_SABULO_CAVE_RARE_BONE               (FLAG_HIDDEN_ITEMS_START + 0x31) // FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVERSTONE_2 in Emerald
#define FLAG_HIDDEN_ITEM_SABULO_CROSS_HYPER_POTION           (FLAG_HIDDEN_ITEMS_START + 0x32) // FLAG_HIDDEN_ITEM_ROUTE_109_REVIVE in Emerald
#define FLAG_HIDDEN_ITEM_SABULO_CROSS_YELLOW_SHARD           (FLAG_HIDDEN_ITEMS_START + 0x33) // FLAG_HIDDEN_ITEM_ROUTE_109_GREAT_BALL in Emerald
#define FLAG_HIDDEN_ITEM_SHARPGUST_SPAN_HYPER_POTION         (FLAG_HIDDEN_ITEMS_START + 0x34) // FLAG_HIDDEN_ITEM_ROUTE_109_HEART_SCALE_1 in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_WAY_ELIXIR                   (FLAG_HIDDEN_ITEMS_START + 0x35) // FLAG_HIDDEN_ITEM_ROUTE_110_GREAT_BALL in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_WAY_BLUE_SHARD               (FLAG_HIDDEN_ITEMS_START + 0x36) // FLAG_HIDDEN_ITEM_ROUTE_110_REVIVE in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_WAY_RARE_CANDY               (FLAG_HIDDEN_ITEMS_START + 0x37) // FLAG_HIDDEN_ITEM_ROUTE_110_FULL_HEAL in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_WAY_CHESTO_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x38) // FLAG_HIDDEN_ITEM_ROUTE_111_PROTEIN in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_TOWN_STAR_PIECE              (FLAG_HIDDEN_ITEMS_START + 0x39) // FLAG_HIDDEN_ITEM_ROUTE_111_RARE_CANDY in Emerald
#define FLAG_HIDDEN_ITEM_VALOON_TOWN_BLACK_SLUDGE            (FLAG_HIDDEN_ITEMS_START + 0x3A) // FLAG_HIDDEN_ITEM_PETALBURG_WOODS_POTION in Emerald
#define FLAG_HIDDEN_ITEM_NEMESIS_RIVER_HYPER_POTION          (FLAG_HIDDEN_ITEMS_START + 0x3B) // FLAG_HIDDEN_ITEM_PETALBURG_WOODS_TINY_MUSHROOM_1 in Emerald
#define FLAG_HIDDEN_ITEM_NEMESIS_RIVER_X_SPEED               (FLAG_HIDDEN_ITEMS_START + 0x3C) // FLAG_HIDDEN_ITEM_PETALBURG_WOODS_TINY_MUSHROOM_2 in Emerald
#define FLAG_HIDDEN_ITEM_NEMESIS_CAVE_RARE_BONE              (FLAG_HIDDEN_ITEMS_START + 0x3D) // FLAG_HIDDEN_ITEM_PETALBURG_WOODS_POKE_BALL in Emerald
#define FLAG_HIDDEN_ITEM_NEMESIS_CAVE_FULL_HEAL              (FLAG_HIDDEN_ITEMS_START + 0x3E) // FLAG_HIDDEN_ITEM_ROUTE_104_POKE_BALL in Emerald
#define FLAG_HIDDEN_ITEM_TELMURK_SWAMP_ANTIDOTE              (FLAG_HIDDEN_ITEMS_START + 0x3F) // FLAG_HIDDEN_ITEM_ROUTE_106_POKE_BALL in Emerald
#define FLAG_HIDDEN_ITEM_BATTLE_MARSH_TINY_MUSHROOM          (FLAG_HIDDEN_ITEMS_START + 0x40) // FLAG_HIDDEN_ITEM_ROUTE_109_ETHER in Emerald
#define FLAG_HIDDEN_ITEM_BATTLE_MARSH_NEST_BALL              (FLAG_HIDDEN_ITEMS_START + 0x41) // FLAG_HIDDEN_ITEM_ROUTE_110_POKE_BALL in Emerald
#define FLAG_HIDDEN_ITEM_BATTLE_MARSH_RED_SHARD              (FLAG_HIDDEN_ITEMS_START + 0x42) // FLAG_HIDDEN_ITEM_ROUTE_118_HEART_SCALE in Emerald
#define FLAG_HIDDEN_ITEM_BATTLE_MARSH_BIG_ROOT               (FLAG_HIDDEN_ITEMS_START + 0x43) // FLAG_HIDDEN_ITEM_ROUTE_118_IRON in Emerald
#define FLAG_HIDDEN_ITEM_RIMEWOOD_FOREST_RARE_BONE           (FLAG_HIDDEN_ITEMS_START + 0x44) // FLAG_HIDDEN_ITEM_ROUTE_119_FULL_HEAL in Emerald
#define FLAG_HIDDEN_ITEM_TELMURK_CITY_RARE_CANDY             (FLAG_HIDDEN_ITEMS_START + 0x45) // FLAG_HIDDEN_ITEM_ROUTE_120_RARE_CANDY_2 in Emerald
...
#define FLAG_HIDE_SABULO_ISLAND_SABULO_CAVE_GUARD                   0x303 // FLAG_HIDE_ROUTE_111_VICKY_WINSTRATE in Emerald
#define FLAG_HIDE_SABULO_ISLAND_CIVILIANS                           0x304 // FLAG_HIDE_PETALBURG_GYM_NORMAN in Emerald
#define FLAG_HIDE_SABULO_ISLAND_NEW_ELDERS                          0x305 // FLAG_HIDE_SKY_PILLAR_TOP_RAYQUAZA_2 in Emerald
#define FLAG_HIDE_SABULO_TOWER_SABULO_CAVE_GUARD                    0x306 // FLAG_HIDE_LILYCOVE_CONTEST_HALL_CONTEST_ATTENDANT_1 in Emerald
...
#define FLAG_HIDE_VALOON_TOWN_COULTER                               0x30D // FLAG_HIDE_PETALBURG_GYM_GREETER in Emerald
#define FLAG_HIDE_VALOON_TOWN_HOUSE_1_PKMN_RANGER_M                 0x30E // FLAG_HIDE_MARINE_CAVE_KYOGRE in Emerald
#define FLAG_HIDE_VALOON_TOWN_RANGERS_HQ_VERNON                     0x30F // FLAG_HIDE_TERRA_CAVE_GROUDON in Emerald
...
#define FLAG_ITEM_SABULO_CAVE_RAGGED_MAP                            0x41F // FLAG_ITEM_PETALBURG_WOODS_X_ATTACK in Emerald
#define FLAG_ITEM_SABULO_CROSS_WATER_STONE                          0x420 // FLAG_ITEM_PETALBURG_WOODS_GREAT_BALL in Emerald
#define FLAG_ITEM_SABULO_CROSS_TM31                                 0x421 // FLAG_ITEM_ROUTE_104_POKE_BALL in Emerald
#define FLAG_ITEM_SHARPGUST_SPAN_TM40                               0x422 // FLAG_ITEM_PETALBURG_WOODS_ETHER in Emerald
#define FLAG_ITEM_VALOON_WAY_LEAF_STONE                             0x423 // FLAG_ITEM_MAGMA_HIDEOUT_3F_3R_ECAPE_ROPE
#define FLAG_ITEM_VALOON_WAY_ABILITY_PILL                           0x424 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_1_ORANGE_MAIL
#define FLAG_ITEM_VALOON_WAY_TM30                                   0x425 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_HARBOR_MAIL
#define FLAG_ITEM_VALOON_WAY_GYARADOSITE                            0x426 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_WAVE_MAIL
#define FLAG_ITEM_VALOON_WAY_ZINC                                   0x427 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_SHADOW_MAIL
#define FLAG_ITEM_NEMESIS_RIVER_MAX_REVIVE                          0x428 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_WOOD_MAIL in Emerald
#define FLAG_ITEM_NEMESIS_RIVER_HELIX_FOSSIL                        0x429 // FLAG_ITEM_TRICK_HOUSE_PUZZLE_4_MECH_MAIL in Emerald
#define FLAG_ITEM_NEMESIS_RIVER_HIDDEN_GROTTO_ALTARIANITE           0x42A // FLAG_ITEM_ROUTE_124_YELLOW_SHARD in Emerald
#define FLAG_ITEM_NEMESIS_CAVE_NUGGET                               0x42B // FLAG_ITEM_TRICK_HOUSE_PUZZLE_6_GLITTER_MAIL in Emerald
#define FLAG_ITEM_NEMESIS_CAVE_MAX_POTION                           0x42C // FLAG_ITEM_TRICK_HOUSE_PUZZLE_7_TROPIC_MAIL in Emerald
#define FLAG_ITEM_NEMESIS_CAVE_TM28                                 0x42D // FLAG_ITEM_TRICK_HOUSE_PUZZLE_8_BEAD_MAIL in Emerald
#define FLAG_ITEM_NEMESIS_CAVE_OLD_AMBER                            0x42E // FLAG_ITEM_JAGGED_PASS_BURN_HEAL in Emerald
#define FLAG_ITEM_TELMURK_SWAMP_BROKEN_TOOL                         0x42F // FLAG_ITEM_AQUA_HIDEOUT_B1F_MAX_ELIXIR in Emerald
#define FLAG_ITEM_TELMURK_SWAMP_ELIXIR                              0x430 // FLAG_ITEM_AQUA_HIDEOUT_B2F_NEST_BALL in Emerald
#define FLAG_ITEM_TELMURK_SWAMP_LUCKY_EGG                           0x431 // FLAG_ITEM_MT_PYRE_EXTERIOR_MAX_POTION in Emerald
#define FLAG_ITEM_TELMURK_SWAMP_HYPER_POTION                        0x432 // FLAG_ITEM_MT_PYRE_EXTERIOR_TM_48 in Emerald
#define FLAG_ITEM_BATTLE_MARSH_QUICK_CLAW                           0x433 // FLAG_ITEM_NEW_MAUVILLE_ULTRA_BALL in Emerald
#define FLAG_ITEM_BATTLE_MARSH_MAX_REVIVE                           0x434 // FLAG_ITEM_NEW_MAUVILLE_ESCAPE_ROPE in Emerald
#define FLAG_ITEM_BATTLE_MARSH_RARE_CANDY                           0x435 // FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_6_LUXURY_BALL in Emerald
#define FLAG_ITEM_BATTLE_MARSH_CALCIUM                              0x436 // FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_4_SCANNER in Emerald
...
#define FLAG_ITEM_TELMURK_CITY_WISE_GLASSES                         0x43A // FLAG_ITEM_SHOAL_CAVE_INNER_ROOM_RARE_CANDY in Emerald
#define FLAG_ITEM_TELMURK_CITY_CAMERUPTITE                          0x43B // FLAG_ITEM_SHOAL_CAVE_STAIRS_ROOM_ICE_HEAL in Emerald
#define FLAG_ITEM_TELMURK_CITY_DUSK_BALLS                           0x43C // FLAG_ITEM_VICTORY_ROAD_1F_MAX_ELIXIR in Emerald
#define FLAG_ITEM_TELMURK_CITY_LUCK_INCENSE                         0x43D // FLAG_ITEM_VICTORY_ROAD_1F_PP_UP in Emerald
...
#define FLAG_VISITED_SABULO_ISLAND                  (SYSTEM_FLAGS + 0x15) // FLAG_VISITED_PACIFIDLOG_TOWN in Emerald
#define FLAG_VISITED_PETALBURG_CITY                 (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_VALOON_TOWN                    (SYSTEM_FLAGS + 0x16) // FLAG_VISITED_PETALBURG_CITY in Emerald
#define FLAG_VISITED_SLATEPORT_CITY                 (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_TELMURK_CITY                   (SYSTEM_FLAGS + 0x17) // FLAG_VISITED_SLATEPORT_CITY in Emerald
...
#define FLAG_SYS_NO_PAYOUT                          (SYSTEM_FLAGS + 0x21) // FLAG_UNUSED_0x881 in Emerald
...
#define FLAG_SYS_BUG_CATCHING_CONTEST_MODE          (SYSTEM_FLAGS + 0x2E) // FLAG_UNUSED_0x88E in Emerald
