...
#define FLAG_RECEIVED_SLOWBRONITE                0x75 // FLAG_DEFEATED_MAGMA_SPACE_CENTER in Emerald
...
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_POTION                  (FLAG_HIDDEN_ITEMS_START + 0x0E) // FLAG_HIDDEN_ITEM_UNDERWATER_2_HEART_SCALE in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_ULTRA_BALL             (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_REVIVE                  (FLAG_HIDDEN_ITEMS_START + 0x0F) // FLAG_HIDDEN_ITEM_UNDERWATER_2_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_STARDUST               (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_COULTERS_HOUSE_2F_RARE_CANDY        (FLAG_HIDDEN_ITEMS_START + 0x10) // FLAG_HIDDEN_ITEM_UNDERWATER_2_STARDUST in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_PEARL                  (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_WISP_FOREST_SUPER_POTION            (FLAG_HIDDEN_ITEMS_START + 0x11) // FLAG_HIDDEN_ITEM_UNDERWATER_2_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_YELLOW_SHARD           (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_WISP_FOREST_ANTIDOTE                (FLAG_HIDDEN_ITEMS_START + 0x12) // FLAG_HIDDEN_ITEM_UNDERWATER_2_YELLOW_SHARD in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_IRON                   (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_ETHER                   (FLAG_HIDDEN_ITEMS_START + 0x13) // FLAG_HIDDEN_ITEM_UNDERWATER_2_IRON in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_2_BIG_PEARL              (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_AEROUS_ROAD_X_ATTACK                (FLAG_HIDDEN_ITEMS_START + 0x14) // FLAG_HIDDEN_ITEM_UNDERWATER_2_BIG_PEARL in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_3_STAR_PIECE             (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_ARCHAN_HILLS_RARE_CANDY             (FLAG_HIDDEN_ITEMS_START + 0x15) // FLAG_HIDDEN_ITEM_UNDERWATER_3_STAR_PIECE in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_3_HP_UP                  (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_ARCHAN_HILLS_REVIVE                 (FLAG_HIDDEN_ITEMS_START + 0x16) // FLAG_HIDDEN_ITEM_UNDERWATER_3_HP_UP in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_3_HEART_SCALE            (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_ARCHAN_TUNNEL_IRON                  (FLAG_HIDDEN_ITEMS_START + 0x17) // FLAG_HIDDEN_ITEM_UNDERWATER_3_HEART_SCALE in Emerald
...
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_ANTIDOTE             (FLAG_HIDDEN_ITEMS_START + 0x1D) // FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_ULTRA_BALL in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_113_TM_32                     (FLAG_HIDDEN_ITEMS_START + 0x1E)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_ETHER                (FLAG_HIDDEN_ITEMS_START + 0x1E) // FLAG_HIDDEN_ITEM_ROUTE_113_TM_32
#define FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_1_KEY             (FLAG_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_STAR_PIECE           (FLAG_HIDDEN_ITEMS_START + 0x1F) // FLAG_HIDDEN_ITEM_ABANDONED_SHIP_RM_1_KEY in Emerald
...
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_RELIC_SILVER         (FLAG_HIDDEN_ITEMS_START + 0x23) // FLAG_HIDDEN_ITEM_SS_TIDAL_LOWER_DECK_LEFTOVERS in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_1_CALCIUM                (FLAG_HIDDEN_ITEMS_START + 0x24)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_ICE_HEAL             (FLAG_HIDDEN_ITEMS_START + 0x24) // FLAG_HIDDEN_ITEM_UNDERWATER_1_CALCIUM in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_104_POTION                    (FLAG_HIDDEN_ITEMS_START + 0x25)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_PROTEIN              (FLAG_HIDDEN_ITEMS_START + 0x25) // FLAG_HIDDEN_ITEM_ROUTE_104_POTION in Emerald
#define FLAG_HIDDEN_ITEM_UNDERWATER_1_HEART_SCALE_2          (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_X_SP_DEF             (FLAG_HIDDEN_ITEMS_START + 0x26) // FLAG_HIDDEN_ITEM_UNDERWATER_1_HEART_SCALE_2 in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_121_HP_UP                     (FLAG_HIDDEN_ITEMS_START + 0x27)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_RARE_CANDY           (FLAG_HIDDEN_ITEMS_START + 0x27) // FLAG_HIDDEN_ITEM_ROUTE_121_HP_UP in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_121_NUGGET                    (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_WINDMIST_CITY_MOON_STONE            (FLAG_HIDDEN_ITEMS_START + 0x28) // FLAG_HIDDEN_ITEM_ROUTE_121_NUGGET in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_123_REVIVE                    (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_WINDMIST_CITY_RARE_CANDY            (FLAG_HIDDEN_ITEMS_START + 0x29) // FLAG_HIDDEN_ITEM_ROUTE_123_REVIVE in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_113_REVIVE                    (FLAG_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_HIDDEN_ITEM_WINDMIST_SUMMIT_HP_UP               (FLAG_HIDDEN_ITEMS_START + 0x2A) // FLAG_HIDDEN_ITEM_ROUTE_113_REVIVE in Emerald
#define FLAG_HIDDEN_ITEM_LILYCOVE_CITY_PP_UP                 (FLAG_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_HIDDEN_ITEM_WINDMIST_SUMMIT_ELIXIR              (FLAG_HIDDEN_ITEMS_START + 0x2B) // FLAG_HIDDEN_ITEM_LILYCOVE_CITY_PP_UP in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_104_SUPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_WINDMIST_SUMMIT_HYPER_POTION        (FLAG_HIDDEN_ITEMS_START + 0x2C) // FLAG_HIDDEN_ITEM_ROUTE_104_SUPER_POTION in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_116_SUPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x2D)
#define FLAG_HIDDEN_ITEM_WINDMIST_SUMMIT_REVIVE              (FLAG_HIDDEN_ITEMS_START + 0x2D) // FLAG_HIDDEN_ITEM_ROUTE_116_SUPER_POTION in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_106_STARDUST                  (FLAG_HIDDEN_ITEMS_START + 0x2E)
#define FLAG_HIDDEN_ITEM_EDAMIST_HEIGHT_SUN_STONE            (FLAG_HIDDEN_ITEMS_START + 0x2E) // FLAG_HIDDEN_ITEM_ROUTE_106_STARDUST in Emerald
#define FLAG_HIDDEN_ITEM_ROUTE_106_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x2F)
#define FLAG_HIDDEN_ITEM_FROSTBITE_CAVE_RELIC_BAND           (FLAG_HIDDEN_ITEMS_START + 0x2F) // FLAG_HIDDEN_ITEM_ROUTE_106_HEART_SCALE in Emerald
...
#define FLAG_VISITED_NESTPINE_TOWN                  (SYSTEM_FLAGS + 0x13) // FLAG_VISITED_FALLARBOR_TOWN in Emerald
#define FLAG_VISITED_VERDANTURF_TOWN                (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_WINDMIST_CITY                  (SYSTEM_FLAGS + 0x14) // FLAG_VISITED_VERDANTURF_TOWN in Emerald
...
#define FLAG_DONT_CLEAR_SAVED_MUSIC             (SPECIAL_FLAGS_START + 0x3) // FLAG_SPECIAL_FLAG_UNUSED_0x4003 in Emerald
