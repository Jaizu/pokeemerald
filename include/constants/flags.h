...
#define FLAG_CAUGHT_BATTLE_MARSH_SECRET_TEMPLE_KANGASKHAN   0x9D // FLAG_FORCE_MIRAGE_TOWER_VISIBLE in Emerald
#define FLAG_DEFEATED_BATTLE_MARSH_SECRET_TEMPLE_KANGASKHAN 0x9E // FLAG_SOOTOPOLIS_ARCHIE_MAXIE_LEAVE in Emerald
